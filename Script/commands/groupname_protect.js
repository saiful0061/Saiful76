...
module.exports.handleEvent = async ({ api, event }) => {
  try {
    ...
    api.setTitle(savedName, threadID, (err) => {
      ...
      const notify = `
╔═❖════════════❖═╗
⚠️𝐆𝐫𝐨𝐮𝐩 𝐍𝐚𝐦𝐞 𝐏𝐫𝐨𝐭𝐞𝐜𝐭𝐞𝐃!⚠️
╚═❖════════════❖═╝

🔄 কারো দ্বারা গ্রুপের নাম পরিবর্তন করা হয়েছিল,
   তাই বট স্বয়ংক্রিয়ভাবে পূর্বের নাম 
   ★ ${savedName} ★ এ ফিরিয়ে দিয়েছে।

🛡️ অনুগ্রহ করে গ্রুপের নাম পরিবর্তন করবেন না। 
